        ...
        <div className="max-w-7xl mx-auto space-y-8">
          ...
          <div className="bg-white/80 backdrop-blur-xl rounded-3xl shadow-lg shadow-gray-200/50 border border-white/60 overflow-hidden">
            ...
            <div className="px-8 py-5 border-b border-gray-100 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h2 className="font-bold text-gray-800 text-lg">Node Profile Details</h2>
                  <p className="text-xs text-gray-400 mt-0.5">Complete terminal registration information</p>
                </div>
              </div>
            ...
            {loading ? (
              <div className="p-16 text-center">
                <div className="inline-flex flex-col items-center gap-4">
                  ...
                  <div>
                    <p className="text-gray-500 font-medium">Querying terminal node...</p>
                    <p className="text-xs text-gray-400 mt-1">Please wait while we fetch the data</p>
                  </div>
                </div>
              </div>
            ) : usage?.id ? (
                    ...
                    <tr className="group hover:bg-gradient-to-r hover:from-blue-50/50 hover:to-indigo-50/30 transition-all duration-200">
                      ...
                      <td className="px-8 py-5">
                        <div className="flex items-start gap-2">
                          ...
                          <div>
                            <span className="block text-sm font-medium text-gray-700">{usage.street}</span>
                            <span className="text-xs text-gray-400">{usage.cityName}</span>
                          </div>
                        </div>
                      </td>
              ...
              <div className="p-16 text-center">
                <div className="inline-flex flex-col items-center gap-4">
                  ...
                  <div>
                    <p className="text-gray-500 font-semibold">No profile records found</p>
                    <p className="text-sm text-gray-400 mt-1">Enter a valid Node ID above to fetch terminal data</p>
                  </div>
                </div>
              </div>
            )}
          ...
          <div className="text-center py-4">
            <p className="text-xs text-gray-400">
              Terminal Monitoring System • Data refreshed in real-time • All connections encrypted
            </p>
          </div>
        </div>
      </div>
